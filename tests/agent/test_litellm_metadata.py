...
def test_litellm_metadata_tags_interactive_source(monkeypatch):
    ...
    assert metadata["hermes_session_id"] == "sess-123"
...
def test_litellm_metadata_tags_cron_job(monkeypatch):
    ...
    assert metadata["hermes_cron_job_id"] == "abc123"
    assert metadata["hermes_cron_job_name"] == "Daily report"
...
def test_litellm_metadata_marks_delegate(monkeypatch):
    ...
    assert metadata["hermes_parent_session_id"] == "parent-1"
