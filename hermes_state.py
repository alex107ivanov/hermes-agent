...
class SessionDB:
    ...
    def __init__(self, db_path: Path = None, database_config: StateDatabaseConfig = None):
        self.database_config = database_config or (
            StateDatabaseConfig(backend="sqlite", db_path=Path(db_path))
            if db_path is not None
            else resolve_state_database_config()
        )
